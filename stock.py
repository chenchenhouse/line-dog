...
def compare_one(message):
    ...
    headers = {
        "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36",
        "cookie" : "F=d=eWRy9tE9vNbX5TxUnOuXHIaqXIY_SWDv1NVVXSY-; PH=l=zh-Hant-TW; Y=v=1&n=4ricake0uqjtd&l=0i3rvxxvr/o&p=m30vvtw00000000&iz=608&r=gl&intl=tw; A1=d=AQABBFHnTWECEDBw_atHMqW67qPOeEr4UAAFEgEABgLA5GG-Yr3ftrYBfeMBAAcIUedNYUr4UAAID2NmcIsKrUnhqlKIgIq8uAkBBwoBlg&S=AQAAAmFT7wf0h_XJDUM1H5WY_no; A3=d=AQABBFHnTWECEDBw_atHMqW67qPOeEr4UAAFEgEABgLA5GG-Yr3ftrYBfeMBAAcIUedNYUr4UAAID2NmcIsKrUnhqlKIgIq8uAkBBwoBlg&S=AQAAAmFT7wf0h_XJDUM1H5WY_no; GUC=AQEABgJh5MBivkIbnQRx; OTH=v=1&d=eyJraWQiOiIwMTY0MGY5MDNhMjRlMWMxZjA5N2ViZGEyZDA5YjE5NmM5ZGUzZWQ5IiwiYWxnIjoiUlMyNTYifQ.eyJjdSI6eyJndWlkIjoiREQyVUdDTUVPTjZVWEtLMjQ3TTQzSUlUQ1UiLCJwZXJzaXN0ZW50Ijp0cnVlLCJzaWQiOiJ0SkROVUJhZGwydGsifX0.f4-l4cK213D5_tLtVTDkyR7AyIQFWrSiALX-tOCQ393q4jsZQd7iPuuQuLPR1D4uFqlDwfacMm2aVfSJSc451HJwMfppCTp7JsoudYHe6w3mWCvzIIgEbtDf5I5-xjt9FNjerbxarE679JODKxaU2W5LmEirtZoTYddrSKUxQj0; T=af=JnRzPTE2NDQzMDgwNDImcHM9dHExTTRscDBjRUxMUzFVTkQ0UmhkQS0t&d=bnMBeWFob28BZwFERDJVR0NNRU9ONlVYS0syNDdNNDNJSVRDVQFhYwFBR1V6Q1c2WAFhbAFhc2QxNTc3NTEBc2MBZGVza3RvcF93ZWIBZnMBWTlwa1NtTmg0dE9oAXp6AUNKTS5oQlJiSAFhAVFBRQFsYXQBdHczNGhCAW51ATA-&kt=EAAx24lRZPTZjWHCAeHdG9F3w--~I&ku=FAAMO.rMhfRWtMfU3Peu0H6MzfBs7aFuUD1lIgBWJP3Hh5bWFymSdE9xr.5VrnF7BafO4Kjl5zi17TFKdGHxzDgJnujyvZMGtpyyI8gCqpacwR4ftPUFmtpOy3i3oisihydRezfOxib2WOtdrWEPzwAxBy57YMj5FIBWMKGOyKdL7Q-~E; B=00k7o99gkrpqh&b=4&d=zsmK7M1tYFpdWj.PY2Bw&s=lp&i=Y2ZwiwqtSeGqUoiAiry4; A1S=d=AQABBFHnTWECEDBw_atHMqW67qPOeEr4UAAFEgEABgLA5GG-Yr3ftrYBfeMBAAcIUedNYUr4UAAID2NmcIsKrUnhqlKIgIq8uAkBBwoBlg&S=AQAAAmFT7wf0h_XJDUM1H5WY_no&j=WORLD; ucs=lbit=1642296837&tr=1645141039000; cmp=t=1645056938&j=0"
    }
    res = requests.get(url,headers= headers)
    while str(res) != "<Response [200]>":
        res = requests.get(url,headers= headers)
